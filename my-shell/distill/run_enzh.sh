python3 /root/workspace/OpenNMT-py/train.py\
    -data /root/workspace/translate_data/distill/my_corpus_v4_enzh.atok.low.distill\
    -save_model mycorpus_model_v4_enzh_distll\
    -train_from /root/workspace/OpenNMT-py/my-shell/mycorpus_model_v4_enzh_distll_step_20000.pt\
    -layers 3 -rnn_size 512 -word_vec_size 512\
    ...
    -tensorboard  -world_size 7 -gpu_ranks 0 1 2 3 4 5 6 
