CUDA_VISIBLE_DEVICES=4,5,6,7 python3 /root/workspace/OpenNMT-py/train.py\
    -data /root/workspace/translate_data/distill/my_corpus_v4_zhen.atok.low.distill\
    -save_model mycorpus_model_v4_zhen_distll\
    ...
    -tensorboard  -world_size 4 -gpu_ranks 0 1 2 3 
